  ...
  private async callAi(
    ...
    try {
      ...
      if (dentallyConnected) {
        ...
        crmLines.push('- dentally_check_availability: para ver los horarios libres de un día (parámetro date en formato YYYY-MM-DD; opcionalmente practitioner_name). Úsala SOLO cuando el cliente ya te haya dado una fecha concreta. NUNCA asumas la fecha de hoy: si el cliente quiere cita pero no dijo qué día, PREGÚNTALE primero qué día desea. Si el cliente no indica con qué profesional, pregúntaselo también (puedes listarlos con dentally_list_practitioners); NO asumas un profesional por tu cuenta.');
