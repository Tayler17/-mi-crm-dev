-- 45_prod_voice_catalog.sql
-- Production migration: voice catalog table + call_bots.voice_catalog_id
...
CREATE TABLE IF NOT EXISTS voices (
  ...
  tts_provider TEXT NOT NULL DEFAULT 'twilio_basic',
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_trigger WHERE tgname = 'update_voices_updated_at'
  ) THEN
