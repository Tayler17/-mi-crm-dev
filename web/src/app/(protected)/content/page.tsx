    ...
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
          {/* Two-column body */}
          <div className="modal-body content-editor-body" style={{ display: 'flex', gap: 0, padding: 0, flex: 1, overflow: 'hidden' }}>

            {/* ── LEFT: Form ─────────────────────────────────────────── */}
            <div className="content-editor-form" style={{ flex: 1, minWidth: 0, padding: '20px 20px 20px 24px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            {/* ── RIGHT: Preview ──────────────────────────────────────── */}
            <div className="content-editor-preview" style={{
