...
const NAV_LABELS: Record<LangCode, Record<string, string>> = {
  ...
  en: {
    ...
    'Prompts IA': 'AI Prompts', 'Asistente de Negocio': 'Business Assistant', 'AI Chatbots': 'AI Chatbots', 'Call Bots': 'Call Bots',
  ...
  pt: {
    ...
    'Prompts IA': 'Prompts IA', 'Asistente de Negocio': 'Assistente de Negócio', 'AI Chatbots': 'AI Chatbots', 'Call Bots': 'Call Bots',
  ...
  tr: {
    ...
    'Prompts IA': 'AI Komutları', 'Asistente de Negocio': 'İş Asistanı', 'AI Chatbots': 'AI Sohbet Botları', 'Call Bots': 'Arama Botları',
  ...
  ar: {
    ...
    'Prompts IA': 'أوامر الذكاء', 'Asistente de Negocio': 'مساعد الأعمال', 'AI Chatbots': 'روبوتات الدردشة', 'Call Bots': 'روبوتات المكالمات',
